...
__11- Kotlinde ve-veya operatörleri lazy çalışma mekanizmasına sahiptir bu ne demek?
...
__12- Verilen bir String dizisinde tekrar eden kaç karatker olduğunu bulan kodu yazınız.
'''
...
__13- Yıldızlar ile çam ağacı çizimi yapın.
'''
...
__14- Değişkenler RAM’de nasıl depolanır?
...
__15- “++number” ve “number++” arasındaki fark nedir?
...
__16- Verilen sayının tek mi çift mi olduğunu dönen fonksiyonu yazınız.
'''
...
__17- “+” operatörü ve plus fonksiyonu aynı işi yapıyorsa ne zaman plus fonksiyonunu ne zaman “+” operatörünü kullanmamız gerekir?
...
__18- If kullanımı ve else if kullanımı arasında nasıl bir fark vardır?
...
__19- Unit ve Nothing arasındaki fark nedir?
...
__20- First Class Citizen nedir?
...
__21- Fonksiyonlarda Default Argument (Name Argument) ne demektir?
...
__23- Fonksiyonlar ne zaman kullanılır?
...
__24- Infix fonksiyona neden default değer atayamayız?
